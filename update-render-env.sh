...
# سكريبت تحديث متغيرات البيئة في Render
# تأكد من تسجيل الدخول إلى Render CLI أولاً: render login

echo "🚀 بدء تحديث متغيرات البيئة في Render..."
...
echo ""
echo "🔧 تعليمات التحديث:"
echo "================================"
echo "1. اذهب إلى Render Dashboard: https://dashboard.render.com"
echo "2. اختر خدمتك: $SERVICE_NAME"
echo "3. اذهب إلى تبويب 'Environment'"
echo "4. أضف كل متغير من المتغيرات التالية:"
echo ""

# عرض المتغيرات مع القيم
for var in "${!ENV_VARS[@]}"; do
    echo "📌 $var"
    echo "   القيمة: ${ENV_VARS[$var]}"
    echo ""
done

echo "💡 نصائح مهمة:"
echo "================================"
echo "• تأكد من نسخ القيم بالكامل بما في ذلك الـ Private Key"
echo "• لا تنس إضافة \\n في نهاية كل سطر من Private Key"
echo "• بعد إضافة جميع المتغيرات، أعد تشغيل الخدمة"
echo "• تحقق من أن NEXT_PUBLIC_SITE_URL يحتوي على رابط Render الصحيح"

echo ""
echo "🚀 بعد إضافة المتغيرات، استخدم هذا الأمر لإعادة تشغيل الخدمة:"
echo "render restart $SERVICE_NAME"
